...
import com.wwtv.player.mediaplayer.LocalPlayerActivity;
...
public class VideoBrowserFragment extends Fragment implements VideoListAdapter.ItemClickListener,
	...
	private static final String CATALOG_URL = "https://raw.githubusercontent.com/WorldwideTV/TVChannels/master/channels.json";
	...
	public void itemClicked(View view, MediaInfo item, int position) {
		if (view instanceof ImageButton) {
			...
			com.wwtv.player.utils.Utils.showQueuePopup(getActivity(), view, item);
		} else {
